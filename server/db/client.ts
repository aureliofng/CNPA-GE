...
if (!('Bun' in globalThis)) {
  throw new Error('CNPA-GE requiere runtime Bun. Ejecuta con `bun dev` o `bun run` para usar bun:sqlite.')
}

const bunSqliteModule = await import('bun' + ':sqlite')
const Database = bunSqliteModule.Database
